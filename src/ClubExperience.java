...
/**
 * ClubExperience Class
 * Contains the information related to a club experience
...
public class ClubExperience extends Experience {
     ...
     */
    public ClubExperience(String title, ArrayList<String> details,
     ...
     */
    public ClubExperience(String title, ArrayList<String> details,
                            Date startDate, Date endDate, String role) {
        super(title, details, startDate, endDate);
        this.role = role;
    }
