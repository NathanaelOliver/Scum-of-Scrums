 ...
 * Contains the information related to a work experience
...
public class WorkExperience extends Experience {
     ...
     * @param endDate end date of the experience
     */
    public WorkExperience(String title, ArrayList<String> details, Date startDate, Date endDate, ArrayList<Reference> references) {
        super(title, details, startDate, endDate);
        this.references = references;
    }

    /**
     * Adds a reference to the work experience references
     * TODO - Do we want to ask for user input in here?
     * Or do we want to send all the required information for the reference into the method?
     */
